...
while(True):
    ...
    # images loading
    moveleft = [pygame.transform.rotate(pygame.transform.scale(pygame.image.load('offroad/body.png'), (140, 80)), 35),
                pygame.transform.rotate(pygame.transform.scale(pygame.image.load('offroad/body.png'), (140, 80)), 35)]
    ...
    backwheel_img = [pygame.transform.scale(pygame.image.load('offroad/tire.png'), (tire_diameter, tire_diameter)),
                     pygame.transform.scale(pygame.image.load('offroad/tire1.png'), (tire_diameter, tire_diameter))]
    frontwheel_img = [pygame.transform.scale(pygame.image.load('offroad//tire.png'), (tire_diameter, tire_diameter)), pygame.transform.scale(
        pygame.transform.rotate(pygame.image.load('offroad/tire.png'), (90)), (tire_diameter, tire_diameter))]
    ...
    # tiles
    tiles = pygame.transform.scale(pygame.image.load(
        'tiles/Crate.png'), (tile_length, tile_length))
    tiles_array = []
    ...
    def redrawgamewindow():
        ...
        win.blit(backwheel_img[rollCount],
                 (bike.back_wheel_x, bike.back_wheel_y))
    ...
    def scoreFunction():
        ...
        # first number CONTAINS THE POSITION FOR THE SCORE
        win.blit(firstNumberScore, (800, 110))
        ...
        if(score > highscore):  # highscore counts up with your score
            ...
            # first number CONTAINS THE POSITION FOR THE SCORE
            win.blit(firstNumberHighScore, (800, 50))
